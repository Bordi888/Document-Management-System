...
class App extends Component {
    ...
    render() {
      ...
      return (
        <div className="App" style={{backgroundColor: "#06F5DB"}}>
          <header className="App-header" style={{borderColor: "#060606"}}>
            <h1> Document Management System</h1>
            <h4> Indian Institute of Information Technology Guwahati, Assam</h4>
          </header>
